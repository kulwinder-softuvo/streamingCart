...
const opsYourStreamingTimeIsOver = "Your streaming time is over now.";
const areYouSureToLogoutFromApp = "Are you sure to logout from app?";
const ok = "OK";
const cancel = "CANCEL";
const thisEventIsCompleted = "This event is completed.";
const thisEventIsNotLiveNow = "Cannot start event before the scheduled start time. Please wait until the start time to begin the event.";
