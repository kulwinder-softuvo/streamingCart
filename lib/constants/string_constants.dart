...
const enter_host_id = "Enter host ID";
const host_email_address = "HOST EMAIL ADDRESS";
const enter_host_email_address = "Enter host email address";
const host_password = "HOST PASSWORD";
const enter_host_password = "Enter host password";
const login = "LOGIN";
...
const somethinWentWrongConst = "Something went wrong.";
